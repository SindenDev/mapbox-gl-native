...
- (void)layoutOrnaments
{
    CGFloat x, y;
    // scale bar
    x = self.contentInset.left+8;
    y = self.contentInset.top+5;
    
    self.scaleBar.frame = CGRectMake(x, y, CGRectGetWidth(self.scaleBar.frame), CGRectGetHeight(self.scaleBar.frame));
